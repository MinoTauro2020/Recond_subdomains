...
function Nuclei_Attack(){
	...
	cat $host-alive | nuclei -t /root/nuclei-templates/cves | notify -biid @MinoTauro2021Recon_bot -telegram -telegram-api-key 1509414531:AAHjj_dhMKX3H4BK857Jiss8Oxswyj3tWGw -telegram-chat-id -452501166  

	echo -e "\n33% Checking vulnerabilities"

	cat $host-alive | nuclei -t /root/nuclei-templates/vulnerabilities | notify -biid @MinoTauro2021Recon_bot -telegram -telegram-api-key 1509414531:AAHjj_dhMKX3H4BK857Jiss8Oxswyj3tWGw -telegram-chat-id -452501166 | 
